...
const {signup,UpdateUser,activateAccount,getListUser,forgetPassword,emailSend,changerPass , getUser, login,banUser,unbanUser, uploads, deactivateAccount} = require("../controllers/user")
